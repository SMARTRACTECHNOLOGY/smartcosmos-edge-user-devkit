...
| `page` | String representation long  |  query parameter, defaults to 1 | page number of multi-element returns, starting at 1
...
----
GET /tenants/?name=My%20Example%20Company&page=1&size=100
----
.Response
----
200 OK
