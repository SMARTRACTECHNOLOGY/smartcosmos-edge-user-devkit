...
public class UpdateTenantResource {
    ...
    @Autowired
    public UpdateTenantResource(UpdateTenantService service) {
    ...
    public DeferredResult<ResponseEntity> updateTenant(@PathVariable String tenantUrn,
            @RequestBody @Valid RestUpdateTenantRequest restUpdateTenantRequest, SmartCosmosUser user) {
