...
public class RestCreateOrUpdateUserRequestToCreateOrUpdateUserRequestConverter
    ...
    public CreateOrUpdateUserRequest convert(RestCreateOrUpdateUserRequest userRequest) {
        return CreateOrUpdateUserRequest.builder().username(userRequest.getUsername()).emailAddress(userRequest.getEmailAddress())
                .givenName(userRequest.getGivenName()).surname(userRequest.getSurname()).roles(userRequest.getRoles()).active(userRequest.getActive())
                .build();
    }
