...
public class UpdateRoleResource {
    ...
    @Autowired
    public UpdateRoleResource(UpdateRoleService service) {
    ...
    public DeferredResult<ResponseEntity> updateRole(@PathVariable String roleUrn, @RequestBody @Valid RestCreateOrUpdateRoleRequest requestBody,
