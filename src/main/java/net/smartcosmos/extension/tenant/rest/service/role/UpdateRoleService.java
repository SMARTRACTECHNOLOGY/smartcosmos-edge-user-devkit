...
public class UpdateRoleService extends AbstractTenantService {
    ...
    @Autowired
    public UpdateRoleService(TenantDao tenantDao, RoleDao roleDao, SmartCosmosEventTemplate smartCosmosEventTemplate,
    ...
    @Async
    private void updateRoleWorker(DeferredResult<ResponseEntity> response, String roleUrn, RestCreateOrUpdateRoleRequest restRequest,
            SmartCosmosUser user) {

        try {
            final CreateOrUpdateRoleRequest updateRoleRequest = conversionService.convert(restRequest, CreateOrUpdateRoleRequest.class);
