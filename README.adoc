...
|<<tenantcreate1, Create>>|`POST /tenants`|https://authorities.smartcosmos.net/tenants/create
...
|====================
|Endpoint|REST API|Required Authority
|<<usercreate1, Create>>|`POST /users`|https://authorities.smartcosmos.net/tenants/create
