...
public class CreateUserResource {
    ...
    @Autowired
    public CreateUserResource(CreateUserService service) {
    ...
    public DeferredResult<ResponseEntity> createUser(@RequestBody @Valid RestCreateOrUpdateUserRequest restCreateUserRequest, SmartCosmosUser user) {
