...
public class CreateRoleResource {
    ...
    @Autowired
    public CreateRoleResource(CreateRoleService service) {
    ...
    public DeferredResult<ResponseEntity> createRole(@RequestBody @Valid RestCreateOrUpdateRoleRequest requestBody, SmartCosmosUser user) {
