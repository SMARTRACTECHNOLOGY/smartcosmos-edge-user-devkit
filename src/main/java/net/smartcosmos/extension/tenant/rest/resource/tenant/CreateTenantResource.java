...
public class CreateTenantResource {
    ...
    @Autowired
    public CreateTenantResource(CreateTenantService service) {
    ...
    public DeferredResult<ResponseEntity> createTenant(@RequestBody @Valid RestCreateTenantRequest restCreateTenantRequest,
